...
$(function () {
	...
	var calculator = new __WEBPACK_IMPORTED_MODULE_0__calc__["a" /* Calculator */]();
...
const calc_modes = [{ name: 'Standard', value: 0, operations: ['+', '-', '*', '/'] }, { name: 'Scientific', value: 1, operations: ['+', '-', '*', '/', 'x^y', 'root'] }, { name: 'Programmer', value: 2, operations: ['+', '-', '*', '/', 'mod'] }];
class Calculator {
    ...
    renderExpressions() {
        ...
        var html = `<div>
            ...
            <div class="col-expr">
                <select class="select-expr" id="operator">` + this.renderOperationOptions() + `</select>
            </div>
            <div class="col-expr">
    ...
    renderPage() {
        ...
        ` + this.renderModes() + this.renderExpressions() + `</div>`;
